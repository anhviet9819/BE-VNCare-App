...
public interface DangKyKhamRepository extends JpaRepository<DangKyKham, Long> {
	//query
	//List<DangKyKham> (Date thoigiandkBegin, Date thoigiandkEnd);
	List<DangKyKham> findAllByThoigiandkBetweenAndThoigiankhamBetween(Date thoigiandkBeOffsetDateTimegin, Date thoigiandkEnd, Date thoigiankhamBegin, Date thoigiankhamEnd);
